...
<head>
    ...
    <title>Bakery Management System Website</title>
		...
		<!-- Logo -->
           ...
           <!-- Main Menu -->
            <div class="menu text-right">
                <ul>
                    <li>
                        <a class="hvr-underline-from-center" href="<?php echo SITEURL ?>admin/">Dashboard</a>
                    </li>
                    <li>
						<?php 
                    ...
                    <li>
                        <a href="<?php echo SITEURL ?>admin/food.php">Items</a>
                    </li>
                    <li>
						<?php 
